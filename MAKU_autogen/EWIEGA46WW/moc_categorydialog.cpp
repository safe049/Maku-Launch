...
struct qt_meta_stringdata_CLASSCategoryDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCategoryDialogENDCLASS = QtMocHelpers::stringData(
    "CategoryDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCategoryDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject CategoryDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCategoryDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCategoryDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCategoryDialogENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *CategoryDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCategoryDialogENDCLASS.stringdata0))
